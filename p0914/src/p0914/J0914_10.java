...
public class J0914_10 {
	...
	public static void main(String[] args) {
		//("aaa","1111","홍길동","서울","010-1111-1111");
		//("bbb","2222","유관순","부산","010-2222-2222");
		//("ccc","3333","이순신","대구","010-3333-3333");
		//("ddd","4444","강감찬","인천","010-4444-4444");
		//("eee","5555","김구","광주","010-5555-5555");
		...
		m[4] = new Member("eee","5555","김구","광주","010-5555-5555");
